...
urlpatterns = [
    ...
    path('teacher/courses/<int:course_id>/lessons/',
         TeacherLessonCreateView.as_view(), name="teacher-add-lesson"),
    path("teacher/lessons/<int:lesson_id>/",
         TeacherLessonDetailView.as_view(), name="teacher-edit-delete-lesson"),
    ...
    path("lessons/comments/<int:lesson_id>/",
         LessonCommentsView.as_view(), name="lesson_comments"),

    path("comments/reply/<int:comment_id>/",
         ReplyCommentsView.as_view(), name="reply_comment"),
