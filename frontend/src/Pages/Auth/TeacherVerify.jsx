        ...
        <div className="space-y-8 lg:col-span-2">
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-lg">
              Help us verify your credentials and get you started on
              LearnBridge.
            </p>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className={`flex items-center justify-center gap-2 py-2 rounded-lg border transition-all text-sm font-semibold ${
                  teacherType === "fresher"
