      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10 space-y-4">
          ...
          <div>
            ...
            <p className="text-amber-500/80 text-sm font-medium tracking-wide uppercase mt-2">
        ...
        <div className="relative w-full max-w-md bg-[#16181D]/80 backdrop-blur-xl border border-amber-500/10 rounded-3xl p-6 md:p-8 shadow-2xl relative z-10 mx-auto">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs text-gray-400 ml-1 font-medium uppercase tracking-wider">
                Admin Email
              </label>
              <input
                type="email"
