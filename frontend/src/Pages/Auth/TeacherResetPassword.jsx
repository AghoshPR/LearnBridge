            ...
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-10">
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-500 text-lg max-w-md">
                            Your new password must be different from previous used passwords.<br />
                    ...
                    <div className="hidden md:block space-y-4">
                        <FeatureRow
                            ...
                            desc="Password encryption required"
                            color="bg-blue-100 text-blue-600"
                        />
                        <FeatureRow
                            icon={Clock}
                            title="Instant Update"
                            desc="Access your account immediately"
                            color="bg-amber-100 text-amber-600"
                        />
                        <FeatureRow
                            icon={CheckCircle}
                            title="All Done?"
                            desc="Log in with your new credentials"
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 max-w-md w-full mx-auto lg:ml-auto border border-gray-100">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 mt-2 text-sm">Create a strong, unique password</p>
                    </div>
