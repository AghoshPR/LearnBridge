      ...
      <main className="flex-1 ml-0 lg:ml-64 p-4 md:p-8 pt-20 lg:pt-8 transition-all duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {currentCourses.map((course) => (
            <div
              key={course.id}
              className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden hover:border-slate-700 transition-all duration-300 group"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() =>
                      navigate(`/teacher/managecourses/${course.id}`)
                    }
