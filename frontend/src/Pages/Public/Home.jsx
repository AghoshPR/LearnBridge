          ...
          <div className="flex flex-wrap justify-center gap-3 text-sm text-blue-100 items-center justify-center">
            ...
            {popularTags.map((tag) => (
              <button
                ...
                className="px-3 py-1 bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-sm transition-colors border border-white/10"
              >
                {tag.tag_name}
              </button>
            ))}
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="mb-12">
            ...
            <p className="text-gray-600">
              Choose from thousands of courses in various fields
            </p>
          </div>
            ...
            {categories.map((category, idx) => {
              ...
              return (
                <div
                  key={category.id}
                  onClick={() => navigate("/courses")}
                  className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-blue-100 transition-all cursor-pointer group flex items-start gap-4"
                >
                  <div
                    className={`${IconData.color} p-3 rounded-xl shadow-md group-hover:scale-110 transition-transform duration-300`}
                  >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex justify-between items-end mb-12">
            ...
            <button
              onClick={() => navigate("/courses")}
              className="text-sm font-semibold text-gray-500 hover:text-blue-600 flex items-center gap-1 border border-gray-200 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
            >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col gap-4">
            {questions.map((q, idx) => (
              <div
                key={q.id}
                onClick={() => navigate(`/question-community/${q.id}`)}
                className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex gap-6 cursor-pointer"
              >
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {q.tags &&
                      q.tags.map((tag) => (
                        <span
                          key={tag.id}
                          className="px-2 py-1 bg-gray-100 text-gray-600 text-xs font-semibold rounded-md border border-gray-200"
                        >
                          {tag.tag_name}
                        </span>
                      ))}
